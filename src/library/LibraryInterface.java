...
public class LibraryInterface {
    ...
    public static void main(String[] args) {
        ...
        if(p.borrow(b2))    System.out.println(b2.getTitle() + " sucessfully borrowed");
        else                System.out.println(b2.getTitle() + " could not be borrowed");
        
        if(p.borrow(b3))    System.out.println(b3.getTitle() + " sucessfully borrowed");
        else                System.out.println(b3.getTitle() + " could not be borrowed");
        
        if(p.borrow(b4))    System.out.println(b4.getTitle() + " sucessfully borrowed");
